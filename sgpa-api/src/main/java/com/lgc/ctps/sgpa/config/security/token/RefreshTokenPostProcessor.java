 ...
 * @author H199653
 *
 *         Remove o RefreshToken da requisição e adiciona no cookie do browser
 */
@ControllerAdvice
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	private void addRefreshTokenToCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(false); // TODO: Mudar para true em producao (CAso seja HTTPS)
